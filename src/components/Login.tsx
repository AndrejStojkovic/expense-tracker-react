        ...
        <div className='p-6 space-y-4 sm:p-8'>
          ...
          <form action='#'>
            <div>
              ...
              <input type='email' name='email' id='email' className='bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2' placeholder='name@company.com' required />
            </div>
            <div className='mt-2'>
