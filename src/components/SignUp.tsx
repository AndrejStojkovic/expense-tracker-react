          ...
          <form action='#'>
            <div className='flex justify-between'>
              <div>
                ...
                <input type='text' name='first_name' id='first_name' className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2' placeholder='John' required />
              </div>
              <div>
